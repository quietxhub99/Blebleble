...
_G.RERollSkinCrate = Net:RemoteEvent("RollSkinCrate")
_G.RFPurchaseSkinCrate = Net:RemoteFunction("PurchaseSkinCrate")
...
DStones:Button({
    ...
    Locked = false,
    Callback = function()
        _G.ActivateDoubleEnchant = Net:RemoteEvent("ActivateSecondEnchantingAltar")
...
DStones:Button({
    ...
    Locked = false,
    Callback = function()
        _G.CreateTranscendedStone = Net:RemoteFunction("CreateTranscendedStone")
...
DStones:Button({
	...
	Callback = function()
		_G.ActiveStone = Net:RemoteEvent("ActivateSecondEnchantingAltar")
...
function sendFishWebhook(fishName, rarityText, assetId, itemId, variantId)
    ...
    local WebhookURL = "https://discordapp.com/api/webhooks/1454776265318858814/j93L5sDeB24pKdhxmY4S6BOPLOzVuxh3A8B5JnGlQc_dpqbtJ9gxeokOQWQMAuiGsY6o"
