...
_G.AntiBugEnabled = _G.AntiBugEnabled or false
_G.LastFishTime = _G.LastFishTime or nil
_G.MonitorStarted = _G.MonitorStarted or false
_G.StopFishing = _G.StopFishing or function()
    warn("⚠️ StopFishing() belum didefinisikan!")
end
    ...
    task.spawn(function()
        ...
        while _G.AntiBugEnabled do
            ...
            if tick() - _G.LastFishTime > 10 then
                NotifyWarning("Anti Bug", "Bug Detected, Reloading Fishing!!...")
...
if _G.REObtainedNewFishNotificationConnection then
    _G.REObtainedNewFishNotificationConnection:Disconnect()
end

_G.REObtainedNewFishNotificationConnection = _G.REObtainedNewFishNotification.OnClientEvent:Connect(function(itemId, metadata, data, newlyIndexed)
    _G.LastFishTime = tick()
...
local farmLocations = {
    ...
    ["Crystal Cavern"] = {
    	CFrame.new(-2027.59424, -440.000519, 7429.38135, 0.897615969, -6.41856559e-08, -0.440778375, 4.09538856e-08, 1, -6.22190086e-08, 0.440778375, 3.77971858e-08, 0.897615969),
    	CFrame.new(-2056.25635, -448.5, 7387.78271, -0.100679129, -2.6062402e-08, -0.994918942, 1.10323406e-07, 1, -3.73594915e-08, 0.994918942, -1.13524166e-07, -0.100679129),
    	CFrame.new(-2031.5105, -448.5, 7341.23096, -0.840611517, -1.96273504e-08, -0.541638494, 4.06465723e-08, 1, -9.93196139e-08, 0.541638494, -1.05504959e-07, -0.840611517),
    	CFrame.new(-1956.82727, -440.000488, 7387.51904, -0.024976898, 3.86704571e-08, 0.999688029, -7.61459944e-08, 1, -4.05850109e-08, -0.999688029, -7.71359296e-08, -0.024976898)
    }
}
